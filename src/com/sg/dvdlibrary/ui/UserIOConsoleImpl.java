...
public class UserIOConsoleImpl implements UserIO {
    ...
    public int readInt(String msgPrompt) {
        ...
        while (invalidInput) {
            try {
                /*print the message msgPrompt. readString returns a "number", therefore stringValue
                becomes a "number"*/
                String stringValue = this.readString(msgPrompt);
                /*converting stringValue into a integer and storing it into our num variable. If unable
                to convert, most likely because it is not an actual number but maybe a word, it'll break*/
                num = Integer.parseInt(stringValue);
                invalidInput = false; // or you can use 'break;' once it hits this, it breaks the loop
    ...
    public int readInt(String msgPrompt, int min, int max) {
        int result;
        do {
            result = readInt(msgPrompt); //resul will be = to wtv number is returned from the other readInt method
